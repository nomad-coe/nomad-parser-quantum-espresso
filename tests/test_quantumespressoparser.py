...
def test_multirun(parser):
    ...
    assert np.shape(sec_runs[0].section_single_configuration_calculation[0].eigenvalues[0].band_energies[39].value) == (100,)
    assert np.shape(sec_runs[1].section_single_configuration_calculation[0].eigenvalues[0].band_energies[39].value) == (100,)
    assert np.shape(sec_runs[2].section_single_configuration_calculation[0].eigenvalues[0].band_energies[39].value) == (100,)
    assert len(sec_runs[0].section_single_configuration_calculation[0].eigenvalues[0].kpoints) == 20
    assert len(sec_runs[1].section_single_configuration_calculation[0].eigenvalues[0].kpoints) == 20
    assert len(sec_runs[2].section_single_configuration_calculation[0].eigenvalues[0].kpoints) == 20
    assert sec_runs[0].section_single_configuration_calculation[0].eigenvalues[0].kpoints[10][1] == approx(-0.1667096)
    assert sec_runs[1].section_single_configuration_calculation[0].eigenvalues[0].band_energies[3].value[-5].magnitude == approx(1.42385437e-19)
    assert sec_runs[2].section_single_configuration_calculation[0].eigenvalues[0].band_energies[30].value.magnitude[35] == approx(-7.25180392e-18)

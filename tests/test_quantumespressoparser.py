...
def test_scf(parser):
    ...
    assert np.shape(sec_scc.eigenvalues[0].value[0][0]) == (4,)
...
def test_multirun(parser):
    ...
    assert np.shape(sec_runs[2].section_single_configuration_calculation[0].eigenvalues[0].value[1][19]) == (100,)
    ...
    assert sec_runs[1].section_single_configuration_calculation[0].eigenvalues[0].value[0][3][-5].magnitude == approx(1.42385437e-19)
    assert sec_runs[2].section_single_configuration_calculation[0].eigenvalues[0].value[1][-10].magnitude[35] == approx(-7.25180392e-18)

            ...
            SM(name='header',
               ...
               subMatchers=[
                   SM(name='serial_multithread',
                      startReStr=r"\s*(?P<x_qe_compile_parallel_version>Serial multi-threaded) version, running on\s*(?P<x_qe_nthreads>\d+)\s*processor cores",
                   ),
                   ...
                   SM(name='ibrav', required=True,
                      startReStr=r"\s*bravais-lattice index\s*=\s*(?P<x_qe_ibrav>\d+)",
                   ),
                   ...
                   SM(name='cell_volume', required=True,
                      startReStr=r"\s*unit-cell volume\s*=\s*(?P<x_qe_cell_volume__bohr3>" + RE_f + r")\s*\(a\.u\.\)\^3",
                   ),
                   ...
                   SM(name='nelec', required=True,
                      startReStr=r"\s*number of electrons\s*=\s*(?P<x_qe_number_of_electrons>" + RE_f + r")",
                   ),
                   ...
                   SM(name='convergence_threshold',
                      startReStr=r"\s*convergence threshold\s*=\s*(?P<x_qe_potential_convergence_threshold>" + RE_f + r")",
                   ),
                   SM(name='mixing_beta',
                      startReStr=r"\s*mixing beta\s*=\s*(?P<x_qe_potential_mixing_beta>" + RE_f + r")",
                   ),
                   SM(name='mixing_scheme',
                      startReStr=r"\s*number of iterations used\s*=\s*(?P<x_qe_potential_mixing_iterations>\d+)\s*(?P<x_qe_potential_mixing_scheme>.*?)\s+mixing",
                   ),

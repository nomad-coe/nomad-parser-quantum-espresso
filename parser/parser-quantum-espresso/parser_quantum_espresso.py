                   ...
                   SM(name='mesh_sticks43',
                      ...
                      subMatchers=[
                          ...
                          SM(name="sticks_summary43", required=True,
                             startReStr=r"\s*(?P<x_qe_sticks43>nst =.*)",
                          ),
                          SM(name="sticks_header43", required=True,
                             startReStr=r"\s*(?P<x_qe_sticks43>n\.st\s+n\.stw\s+n\.sts\s+n\.g\s+n\.gw\s+n\.gs)",
                          ),
                          SM(name='sticks_line43', repeats=True,
                             startReStr=r"\s*(?P<x_qe_sticks43>(?:min|max|)(?:\s+\d+){6})\s*$",
                          ),
                      ],
                   ),
